...
class Flow:
    ...
    def cal_flow(self, f0, f0_2, frame2_1, frame2_2):
        ...
        cv2.imshow('frame_left', frame3_1)
        ...
        cv2.imshow('frame_right', frame3_2)
...
if __name__ == "__main__":
    ...
    #     "luoshuan/xuanning_1_success/flow_init picture/flow_init.avi")  # choose to read from video or camera

    # 第二个传感器
    cap_2 = cv2.VideoCapture(0)
    # cap_2 = cv2.VideoCapture("luoshuan/xuanning_1_success/flow_init picture/flow_init_2.avi")
    ...
    plt.figure()
    plt.subplot(4, 1, 1)
    plt.title('Test of moving the grasped object', fontsize=20, fontdict={'family': 'Times New Roman'})
    plt.plot(np.arange(len(Force_x)), Force_x, linewidth=2)
    plt.xticks(fontsize=1, fontproperties='Times New Roman')
    plt.yticks(fontsize=18, fontproperties='Times New Roman')
    # plt.ylabel('T(X)',fontsize=20, fontdict={'family': 'Times New Roman'})
    # plt.legend()
    plt.subplot(4, 1, 2)
    plt.plot(np.arange(len(Force_y)), Force_y, linewidth=2)
    plt.xticks(fontsize=1, fontproperties='Times New Roman')
    plt.yticks(fontsize=18, fontproperties='Times New Roman')
    # plt.ylabel('T(Y)', fontsize=20, fontdict={'family': 'Times New Roman'})
    # plt.legend()
    plt.subplot(4, 1, 3)
    plt.plot(np.arange(len(Force_z)), Force_z, linewidth=2)
    plt.xticks(fontsize=1, fontproperties='Times New Roman')
    plt.yticks(fontsize=18, fontproperties='Times New Roman')
    # plt.ylabel('T(Z)', fontsize=20, fontdict={'family': 'Times New Roman'})
    # plt.legend()
    plt.subplot(4, 1, 4)
    plt.plot(np.arange(len(Torque_z)), Torque_z, linewidth=2)
    plt.xticks(fontsize=18, fontproperties='Times New Roman')
    plt.yticks(fontsize=18, fontproperties='Times New Roman')
    # plt.ylabel('T(Rz)', fontsize=20, fontdict={'family': 'Times New Roman'})
    plt.xlabel('frame', fontsize=20, fontdict={'family': 'Times New Roman'})
    plt.legend()
    plt.show()

# Rz = np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=25.06(x+5,y+5.5)/torquez_move_beta=25.06_(x+5,y+5).txt')
# Rz = np.append(Rz, np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=25.06(x+5,y+5.5)/torquez_keep_beta=25.06_(x+5,y+5).txt'))
# Rz_2 = np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=25.96(x+5,y+5.5)/torquez_move_beta=25.96_(x+5,y+5).txt')
# Rz_2 = np.append(Rz_2, np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=25.96(x+5,y+5.5)/torquez_keep_beta=25.96_(x+5,y+5).txt'))
# Rz_3 = np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=26.56(x+5,y+5.5)/torquez_move_beta=26.56_(x+5,y+5).txt')
# Rz_3 = np.append(Rz_3, np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=26.56(x+5,y+5.5)/torquez_keep_beta=26.56_(x+5,y+5).txt'))
# Rz_4 = np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=28.24(x+5,y+5.5)/torquez_move_beta=28.24_(x+5,y+5).txt')
# Rz_4 = np.append(Rz_4, np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=28.24(x+5,y+5.5)/torquez_keep_beta=28.24_(x+5,y+5).txt'))
#
# Rz = np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=-47.06(x+5,y-5.5)/torquez_move_beta=-47.06_(x+5,y-5).txt')
# Rz = np.append(Rz, np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=-47.06(x+5,y-5.5)/torquez_keep_beta=-47.06_(x+5,y-5).txt'))
# Rz_2 = np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=-44.92(x+5,y-5.5)/torquez_move_beta=-44.92_(x+5,y-5).txt')
# Rz_2 = np.append(Rz_2, np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=-44.92(x+5,y-5.5)/torquez_keep_beta=-44.92_(x+5,y-5).txt'))
# Rz_3 = np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=-41.66(x+5,y-5.5)/torquez_move_beta=-41.66_(x+5,y-5).txt')
# Rz_3 = np.append(Rz_3, np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=-41.66(x+5,y-5.5)/torquez_keep_beta=-41.66_(x+5,y-5).txt'))
# Rz_4 = np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=-36.75(x+5,y-5.5)/torquez_move_beta=-36.75_(x+5,y-5).txt')
# Rz_4 = np.append(Rz_4, np.loadtxt(r'force meaurment/period_edge_perception_1(front)/verify/wubianxing/beta=-36.75(x+5,y-5.5)/torquez_keep_beta=-36.75_(x+5,y-5).txt'))
#
# Rz = np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=119.33/torquez_move_beta=119.33_(x-5,y+5).txt')
# Rz = np.append(Rz, np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=119.33/torquez_keep_beta=119.33_(x-5,y+5).txt'))
# Rz_2 = np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=113.95/torquez_move_beta=113.95_(x-5,y+5).txt')
# Rz_2 = np.append(Rz_2, np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=113.95/torquez_keep_beta=113.95_(x-5,y+5).txt'))
# Rz_3 = np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=108.45/torquez_move_beta=108.45_(x-5,y+5).txt')
# Rz_3 = np.append(Rz_3, np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=108.45/torquez_keep_beta=108.45_(x-5,y+5).txt'))
# Rz_4 = np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=106.69/torquez_move_beta=106.69_(x-5,y+5).txt')
# Rz_4 = np.append(Rz_4, np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=106.69/torquez_keep_beta=106.69_(x-5,y+5).txt'))
#
# Rz = np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=-102.62/torquez_move_beta=-102.62_(x-5,y-5).txt')
# Rz = np.append(Rz, np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=-102.62/torquez_keep_beta=-102.62_(x-5,y-5).txt'))
# Rz_2 = np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=-104.09/torquez_move_beta=-104.09_(x-5,y-5).txt')
# Rz_2 = np.append(Rz_2, np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=-104.09/torquez_keep_beta=-104.09_(x-5,y-5).txt'))
# Rz_3 = np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=-105.73/torquez_move_beta=-105.73_(x-5,y-5).txt')
# Rz_3 = np.append(Rz_3, np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=-105.73/torquez_keep_beta=-105.73_(x-5,y-5).txt'))
# Rz_4 = np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=-107.07/torquez_move_beta=-107.07_(x-5,y-5).txt')
# Rz_4 = np.append(Rz_4, np.loadtxt(r'force meaurment/period_edge_perception_2(behind)/verify/wubianxing/beta=-107.07/torquez_keep_beta=-107.07_(x-5,y-5).txt'))
